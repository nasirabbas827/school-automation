...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["profile_pic"]["tmp_name"], $profile_pic)) {
            ...
            $sql = "INSERT INTO Staff (profile_pic, first_name, last_name, dob, gender, address, phone, email, password, position) 
                    VALUES ('$profile_pic', '$first_name', '$last_name', '$dob', '$gender', '$address', '$phone', '$email', '$password', '$position')";
...
<div class="container mb-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <a class="btn btn-outline-dark" href="view_staff.php"> View Staff</a>
